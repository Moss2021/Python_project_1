...
print("Hello " + name + ", first choose your fruit flavor and how you want it prepared! \n")
#Ask user for name and fruit choice
print("Are you ready to order a fruit flavor ? ")
...
while userReply == "yes":    
    ...
    print("Ok! Please choose what you want to do with the fruit!: ")
    print(" \n")
...
print("Fruta Raspada Menu Items: \n")
